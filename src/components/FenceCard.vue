...
export default defineComponent({
  ...
  props: {
    name: {
      type: String,
      default: 'Sesame Street'
    },
    address: {
      type: String,
      default: '123 Sesame Street, New York, USA'
    },
    radius: {
      type: Number,
      default: 200
  ...
  methods: {
    handleDeleteClicked() {
      this.$emit('deleteClicked', this.uid)
    }
  },
})
</script>
